...
toBinary (HexString bs) = B.decode . BSL.fromStrict . fromRight (error "decoding error") . BS16.decode $ bs
...
toBytes (HexString bs) = (fromRight (error "decoding error") . BS16.decode) bs
